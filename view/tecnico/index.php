    ...
    <div class="flex-box">
        <?php foreach($this->tecnicos as $tecnico): ?>
            <?php if($tecnico["tec_empresaFK"] === $_SESSION["id"] || $_SESSION["rol"] === "adm"): ?>
                <?php $avatar = strtoupper(substr($tecnico["tec_nombre1"], 0, 1).substr($tecnico["tec_apellido1"], 0, 1)) ?>
                ...
                <div class="card m-0">
                    <div class="card-info">
                        ...
                        <div class="card-title">
                            <?= $tecnico["tec_nombre1"] ?> <br />
                            <?= $tecnico["tec_apellido1"] ?>
                        </div>
                    ...
                    <ul class="card-buttons">
                        <li class="card-buttons__item">
                            <button class="editButton openFormEditTecnico" data-id="<?= $tecnico["tec_id"] ?>"
                                data-nombre1="<?= $tecnico["tec_nombre1"] ?>" data-nombre2="<?= $tecnico["tec_nombre2"] ?>"
                                data-apellido1="<?= $tecnico["tec_apellido1"] ?>"
                                data-apellido2="<?= $tecnico["tec_apellido2"] ?>" data-correo="<?= $tecnico["tec_correo"] ?>"
...
<div id="floatingCircle" class="floating-button btnAddTecnico" data-toggle="tooltip" data-title="Agregar Tecnico">
    <i class="fas fa-plus"></i>
</div>
