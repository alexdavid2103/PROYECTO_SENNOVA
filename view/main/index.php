                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                            ...
                            <h2>
                                <span>Sistema</span> Experto al servicio de tu mantenimiento
                            </h2>
                            <p>
                                Prevén averías en tus máquinas y olvídate de los tiempos de
                                inactividad gracias al mejor sistema predictivo del mercado.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                                <div class="icon">
                                    <i class="fa-brands fa-android" style="color: #457b9d"></i>
                                </div>
                                <div class="right-text">
                                    <h4>Inteligencia Artificial</h4>
                                    <p>
                                        Elimine las fallas inesperadas y aumente las horas
                                        productivas
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.7s">
                                <div class="icon">
                                    <i class="fa-solid fa-magnifying-glass-chart" style="color: #457b9d"></i>
                                </div>
                                <div class="right-text">
                                    <h4>Data Reporting</h4>
                                    <p>
                                        Prolongue la vida útil de los activos y reduzca los
                                        costos preventivos
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.9s">
                                <div class="icon">
                                    <i class="fa-solid fa-chart-simple" style="color: #457b9d"></i>
                                </div>
                                <div class="right-text">
                                    <h4>Web Analytics</h4>
                                    <p>
                                        Rentabilidad inmediata de su presupuesto de
                                        mantenimiento
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="1.1s">
                                <div class="icon">
                                    <i class="fa-solid fa-chart-pie" style="color: #457b9d"></i>
                                </div>
                                <div class="right-text">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 align-self-center wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
                <div class="left-image cont_robot">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 798.26 879">
                        <defs>
                            <style>
                                .cls-1 {
                            ...
                            <linearGradient id="linear-gradient" x1="946.92" y1="751.24" x2="947.54" y2="791.25"
                                gradientTransform="translate(1315.85) rotate(-180) scale(1 -1)"
                                gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="#444c8d" />
                                <stop offset="1" stop-color="#26274f" />
                            </linearGradient>
                            <linearGradient id="linear-gradient-2" x1="939.98" y1="830.64" x2="1003.87" y2="637.19"
                                xlink:href="#linear-gradient" />
                            <linearGradient id="linear-gradient-3" x1="933.59" y1="849.52" x2="934.24" y2="866.48"
                                xlink:href="#linear-gradient" />
                            <linearGradient id="linear-gradient-4" x1="976.89" y1="847.84" x2="977.55" y2="864.8"
                                xlink:href="#linear-gradient" />
                            <linearGradient id="linear-gradient-5" x1="1031.1" y1="845.74" x2="1031.76" y2="862.7"
                                xlink:href="#linear-gradient" />
                            <linearGradient id="linear-gradient-6" x1="347.79" y1="781.46" x2="330.74" y2="377.87"
                                gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="#fff" />
                                <stop offset="1" stop-color="#010101" />
                            </linearGradient>
                            <mask id="mask" x="58.96" y="303.9" width="544.79" height="508.03"
                                maskUnits="userSpaceOnUse">
                                <path class="cls-8"
                                    d="M603.75,385.42l-242.17,395.96-2.21,3.61-2.94,4.81-5.15,8.42-3.74,6.11c0,4.07-13.76,7.38-31.06,7.59-.56,.01-1.12,.01-1.68,.01-18.09,0-32.75-3.4-32.75-7.6l-3.43-6.22-6.86-12.44-2.34-4.25-2.94-5.33-14.41-26.15-24.83-45.02-27.97-50.74-2.79-5.07-30.91-56.08-19.65-35.64L58.96,399.65c20.13-15.42,67.1-48.8,135.57-71.77,10.17-3.42,20.81-6.6,31.92-9.46,2.57-.67,5.16-1.31,7.78-1.94,1.97-.47,3.95-.93,5.93-1.37,1.57-.36,3.15-.71,4.74-1.05h.02c23.68-5.07,49.23-8.59,76.5-9.74,3.28-.15,6.59-.25,9.93-.32,52.06-1.1,98.44,6.7,137.86,18.11,1.33,.37,2.65,.76,3.96,1.16,.38,.12,.76,.23,1.14,.34,4.2,1.26,8.32,2.58,12.35,3.92,11.03,3.66,21.44,7.57,31.19,11.58,41.14,16.93,70.6,35.8,85.9,46.32Z" />
                            </mask>
                        </defs>
                        <g class="cls-9">
                            <g id="Capa_1" data-name="Capa 1">
                                <g>
                                    <g class="tablet">
                                        <g>
                                            <path class="cls-17"
                                                d="M693.5,813.08l-406.07-28.04c-.49-.05-.98-.05-1.47,0l-241.83,10.96c-5.78,.53-5.52,15.67,1.04,16.5l379.98,50.88c1.56,.19,3.13,.19,4.68-.01l262.92-36.94c3.51-.61,4.79-13.04,.75-13.33Z" />
                                            <path class="cls-1"
                                                d="M692.7,812.63l-405.27-38.24c-.49-.05-.98-.05-1.47,0l-240.66,21.13c-4.42,.39-4.53,6.81-.13,7.35l379.98,46.89c1.56,.19,3.13,.19,4.68-.01l262.92-33.98c1.86-.24,1.82-2.95-.05-3.13Z" />
                                            <path class="cls-5"
                                                d="M421.13,845.18c.56,0,1.13-.04,1.69-.11l235.65-30.45c.86-.11,.84-1.36-.02-1.44l-361.87-34.08c-.08,0-.16-.01-.24-.01-.07,0-.15,0-.22,0l-230.04,20.2c-1.07,.09-1.09,1.64-.03,1.78l353.48,44.01c.53,.07,1.08,.1,1.61,.1Z" />
                                            <path class="cls-5"
                                                d="M555.2,830.52c.09,.7,2.3,1.01,4.95,.69,2.65-.32,4.73-1.15,4.64-1.86-.09-.7-2.3-1.01-4.95-.69-2.65,.32-4.73,1.15-4.64,1.86Z" />
                                            <g>
                                                <path class="cls-16"
                                                    d="M363.57,852.22l36.48,4.79c2.66,.35,4.85-.95,4.85-2.91h0c0-1.96-2.18-3.8-4.85-4.12l-36.48-4.26c-2.25-.26-4.06,.97-4.06,2.74h0c0,1.78,1.81,3.46,4.06,3.75Z" />
                                                <path class="cls-18"
                                                    d="M323.72,846.99l30.04,3.95c2.18,.29,3.96-.92,3.96-2.69h0c0-1.77-1.78-3.41-3.96-3.67l-30.04-3.51c-1.87-.22-3.37,.92-3.37,2.54h0c0,1.62,1.5,3.13,3.37,3.38Z" />
                                                <path class="cls-14"
                                                    d="M273.38,840.37l22.85,3c1.64,.22,2.98-.85,2.98-2.39h0c0-1.54-1.34-2.94-2.98-3.13l-22.85-2.67c-1.44-.17-2.59,.85-2.59,2.27h0c0,1.42,1.16,2.73,2.59,2.91Z" />
                                            </g>
                                            <path class="cls-4"
                                                d="M231.08,797.98c35.31,6.29,58.77,19.09,109.45,20.11,43.9,.89,44.22-9.23,95.25-12.42,66.84-4.19,84.27,12.05,152.63,10.65,17.83-.37,41.16-1.97,68.77-7.04l35.52,3.35c1.87,.18,1.92,2.89,.05,3.13l-262.92,33.98c-1.55,.2-3.13,.21-4.68,.01l-321.62-39.69c55.19-18.4,97.44-17.44,127.56-12.08Z" />
                                        </g>
                                        <g>
                                            <path class="cls-2"
                                                d="M314.79,816.57c-18.82,0-46.82-3.26-46.82-12.23s28-12.23,46.82-12.23,46.81,3.26,46.81,12.23-28,12.23-46.81,12.23Zm0-20.88c-28.39,0-43.24,5.64-43.24,8.66s14.85,8.66,43.24,8.66,43.24-5.64,43.24-8.66-14.85-8.66-43.24-8.66Z" />
                                    ...
                                    <g class="robot">
                                        ...
                                        <path class="cls-6"
                                            d="M375.93,115.04h-110.46c-113.26,0-205.07,91.81-205.07,205.07h0c0,60.44,48.99,109.43,109.43,109.43H471.57c60.44,0,109.43-48.99,109.43-109.43h0c0-113.26-91.81-205.07-205.07-205.07Z" />
                                        <path class="cls-6"
                                            d="M356.53,653.78h-71.66c-73.48,0-133.04-59.57-133.04-133.04h0c0-39.21,31.78-70.99,70.99-70.99h195.76c39.21,0,70.99,31.78,70.99,70.99h0c0,73.48-59.57,133.04-133.04,133.04Z" />
                                        <path class="cls-5"
                                            d="M396.89,400.78c-31.23-36.69-17.35-66.03-58.17-115.75-56.17-68.41-121.7-60.67-136.71-107.07-4.16-12.86-4.64-30.5,6.52-54.9-85.55,24.68-148.13,103.55-148.13,197.05h0c0,60.44,48.99,109.43,109.43,109.43H432.79c-15.75-8.59-27.26-18.62-35.9-28.76Z" />
                                        <ellipse class="cls-13" cx="89.91" cy="314.31" rx="58.69" ry="82.47" />
                                        <ellipse class="cls-7" cx="43.48" cy="314.31" rx="25.66" ry="36.06" />
                                        <path class="cls-5"
                                            d="M374.18,579.2c-9.83-46.17-118.58-45.06-121.54-75.24-2.28-23.27,60.16-46.3,68-49.19,6.71-2.48,13.37-4.57,19.96-6.36h-117.79c-39.21,0-70.99,31.78-70.99,70.99h0c0,73.48,59.57,133.04,133.04,133.04h71.66c6.89,0,13.65-.52,20.25-1.53-6.24-7.73-10.3-16.18-11.29-25.41-2.18-20.45,12.49-28.41,8.68-46.3Z" />
                                        <ellipse class="cls-13" cx="322.46" cy="453.7" rx="113.18" ry="13.7" />
                                        <g>
                                            <g>
                                                <path class="cls-12"
                                                    d="M476.19,385.31h-209.96c-28.45,0-51.8-21.81-51.8-48.71v-41.26c0-26.9,23.34-47.97,51.8-47.06l209.96,6.7c25.41,.81,45.78,21.73,45.78,46.73v38.34c0,25-20.37,45.27-45.78,45.27Z" />
                                                <g>
                                                    <path class="cls-2"
                                                        d="M333.5,313.78c0,17.97-15.3,32.34-34.32,32.1-19.19-.24-34.88-15.24-34.88-33.51s15.69-32.63,34.88-32.09c19.02,.53,34.32,15.53,34.32,33.49Z" />
                                                    <path class="cls-2"
                                                        d="M475.39,316.66c0,17.36-14.28,31.26-32.04,31.04-17.91-.23-32.55-14.71-32.55-32.35s14.64-31.53,32.55-31.03c17.76,.5,32.04,14.97,32.04,32.34Z" />
                                                </g>
                                            </g>
                                            <path class="cls-11"
                                                d="M700.11,442.37c-19.32-7.41-40.45-3.68-57.48,8.13-6.22-31.1-25.99-57.42-55.42-68.7-48.23-18.49-104.14,10.37-124.89,64.48-5.35,13.94-7.83,28.2-7.75,42-2.49-1.56-5.14-2.9-7.97-3.98-26.35-10.1-56.9,5.67-68.24,35.23-11.34,29.56,.45,62.79,27.18,71.82,14.28,4.82,36.88,4.91,36.88,4.91,0,0,219.79-16.37,226.57-16.31,27.07,.23,53.76-18.3,65.09-47.84,14.17-36.94-1.04-77.12-33.97-89.74Z" />
                                            <path class="cls-12"
                                                d="M706.65,442.4c-19.32-7.41-40.45-3.68-57.48,8.13-6.22-31.1-25.99-57.42-55.42-68.7-48.23-18.49-104.14,10.37-124.89,64.48-5.35,13.94-7.83,28.2-7.75,42-2.49-1.56-5.14-2.9-7.97-3.98-26.35-10.1-56.9,5.67-68.24,35.23-11.34,29.56,.83,61.72,27.18,71.82,5.58,2.14,36.88,4.91,36.88,4.91,0,0,219.79-16.37,226.57-16.31,27.07,.23,53.76-18.3,65.09-47.84,14.17-36.94-1.04-77.12-33.97-89.74Z" />
                                        </g>
                                        <path class="cls-2"
                                            d="M186.26,490.71c-8.41,6.89-9.64,19.3-2.75,27.71l56.81,69.32,30.46-24.97-56.81-69.32c-6.89-8.41-19.3-9.64-27.71-2.75Z" />
                                        <path class="cls-2"
                                            d="M364.33,556.28c-1.23-10.81-10.99-18.57-21.79-17.34l-89.05,10.13,4.45,39.13,89.05-10.13c10.81-1.23,18.57-10.99,17.34-21.79Z" />
                                        <circle class="cls-11" cx="253.49" cy="572.23" r="28.57"
                                            transform="translate(-199.69 140.57) rotate(-22.5)" />
                                        <path class="cls-11"
                                            d="M346.16,542.58l14.71,36.1c2.19,5.37,10.48,6.96,16.8,3.15,9.27-5.58,19.4-15.1,15.31-28.87-5.17-17.42-20.57-22.44-33.23-23.46-8.59-.69-16.19,6.67-13.58,13.08Z" />
                                    </g>
                                </g>
                            </g>
                        </g>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
                <div class="section-heading">
                    <h2>
                        Una <em>solucion</em> para cada reto en tu rutina de
                        mantenimiento.
                    </h2>
                    <p>
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="section-heading wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s">
                    <h2>
                        Implementación <em>Rapida</em> &amp; Eficaz
                        <span>Intuitiva</span>
                    </h2>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.25s">
                <div class="section-heading">
                    <h2>
                        Como Funciona <em>Trending</em> In Our Latest <span>News</span>
                    </h2>
                </div>
            </div>
            <div class="col-lg-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.25s">
        ...
        <div class="row">
            <div class="col-lg-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
                <div class="left-image">
                    <a href="#"><img src="public/landing_page/assets/images/Funciones.png"
