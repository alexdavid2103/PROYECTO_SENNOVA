<form action="?controller=motor&action=edit" id="multi-step-form" class="form form_edit_motor" onsubmit="return false">
    <div id="form-container-box">
        ...
        <div class="step-group" id="step-group-2">
            ...
            <div class="form-box">
                <div class="form-group">
                    <input type="text" id="edit_mot_mom_inercia" class="form-field" placeholder="Momento de inercia">
                </div>
            </div>
        ...
        <div class="step-group" id="step-group-3">
            ...
            <div class="form-box">
                <div class="form-group">
                    <input type="text" id="edit_mot_rotacion_nominal" class="form-field" placeholder="Rotación nominal">
                </div>
            ...
            <div class="form-box">
                ...
                <div class="form-group">
                    <input type="text" id="edit_mot_carcasaValor" class="form-field" placeholder="Valor de la carcasa">
                </div>
            </div>
