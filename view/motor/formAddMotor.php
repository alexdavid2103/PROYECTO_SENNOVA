<form action="?controller=motor&action=add" id="multi-step-form" class="form form_add_motor" onsubmit="return false">
    <div id="form-container-box">
        ...
        <div class="step-group" id="step-group-3">
            ...
            <div class="form-box">
                <div class="form-group">
                    <input type="text" id="add_mot_carcasaNombre" class="form-field" placeholder="Nombre de la carcasa">
                </div>
                <div class="form-group">
                    <input type="text" id="add_mot_carcasaValor" class="form-field" placeholder="Valor de la carcasa">
                </div>
            </div>
