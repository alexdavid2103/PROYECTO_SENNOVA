...
let RegCliente = async (event) => {
    ...
    if (id == "" || nombre1 == "" || apellido1 == "" || correo == "" || telefono == "" || direccion == "" || municipioFK == "") {
        event.preventDefault();
        swal({
            title: "Error",
...
let editCliente = async (event) => {
    ...
    // Validar si los campos están vacíos
    if (id == "" || nombre1 == "" || nombre2 == "" || apellido1 == "" || apellido2 == "" || correo == "" || telefono == "" || direccion == "" || password == "" || municipioFK == "" || estadoFK == "") {
        event.preventDefault();
        swal({
            title: "Error",
...
let RegMotor = async (event) => {
    ...
    let tiempo_rotor_bloq = document.getElementById("add_mot_tiempo_rotor_bloq").value;
    let peso = document.getElementById("add_mot_peso").value;
    let niv_ruido = document.getElementById("add_mot_niv_ruido").value;
    let factor_servicio = document.getElementById("add_mot_factor_servicio").value;
    let rotacion_nominal = document.getElementById("add_mot_rotacion_nominal").value;
    let corriente_nominal = document.getElementById("add_mot_corriente_nominal").value;
    ...
    // Validar si los campos están vacíos
    if (serie == "" || norma == "" || polos == "" || potencia == "" || IpIn == "" || par_arranque == "" || par_maxima == "" || mom_inercia == "" || tiempo_rotor_bloq == "" || peso == "" || niv_ruido == "" || factor_servicio == "" || rotacion_nominal == "" || corriente_nominal == "" || altitud == "" || regimen == "" || temp_ambiente == "" || proteccion == "" || carcasaFK == "" || eficienciaFK == "" || fac_potenciaFK == "" || clienteFK == "" || tecnicoFK == "" || estadoFK == "") {
        event.preventDefault();
        swal({
            title: "Error",
            text: "Todos los campos son obligatorios, asegúrese de llenar los campos correctamente",
...
let editMotor = async (event) => {
    ...
    let tiempo_rotor_bloq = document.getElementById("edit_mot_tiempo_rotor_bloq").value;
    let peso = document.getElementById("edit_mot_peso").value;
    let niv_ruido = document.getElementById("edit_mot_niv_ruido").value;
    let factor_servicio = document.getElementById("edit_mot_factor_servicio").value;
    let rotacion_nominal = document.getElementById("edit_mot_rotacion_nominal").value;
    let corriente_nominal = document.getElementById("edit_mot_corriente_nominal").value;
