...
edit_motor.forEach((motor) => {
    motor.addEventListener("click", () => {
        ...
        document.getElementById("edit_motor_cliente").options[0].innerHTML = cliente_nom
        ...
        document.getElementById("edit_motor_posicion").options[0].innerHTML = posicion;
        document.getElementById("edit_motor_humedad").options[0].value = humedad;
        document.getElementById("edit_motor_humedad").options[0].innerHTML = humedad;
        document.getElementById("edit_motor_tipo_base").options[0].value = tipo_base;
        document.getElementById("edit_motor_tipo_base").options[0].innerHTML = tipo_base;
        document.getElementById("edit_motor_ventilacion").options[0].value = ventilacion;
        document.getElementById("edit_motor_ventilacion").options[0].innerHTML = ventilacion;
    });
});
