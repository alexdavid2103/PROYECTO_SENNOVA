...
class motor_controller
{
    ...
    public function add()
    {
        ...
        $data = array(
            ...
            "potencia" => $potencia,
            "IpIn" => $IpIn,
            "par_arranque" => $par_arranque,
            "par_maxima" => $par_maxima,
            "mom_inercia" => $mom_inercia,
            "tiempo_rotor_bloq" => $tiempo_rotor_bloq,
            "peso" => $peso,
            "niv_ruido" => $niv_ruido,
            "factor_servicio" => $factor_servicio,
            "rotacion_nominal" => $rotacion_nominal,
            "corriente_nominal" => $corriente_nominal,
            "altitud" => $altitud,
            "temp_ambiente" => $temp_ambiente,
            "proteccion" => $proteccion,
            "carcasaNombre" => $carcasaNombre,
            "carcasaValor" => $carcasaValor,
            "eficienciaPorcentaje" => $eficienciaPorcentaje,
            "eficienciaValor" => $eficienciaValor,
            "fac_potenciaPorcentaje" => $fac_potenciaPorcentaje,
            "fac_potenciaValor" => $fac_potenciaValor,
            "tecnicoFK" => $tecnicoFK,
        );
